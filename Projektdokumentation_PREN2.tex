...
\begin{enumerate}
	...
	\item Während der gesamten Fahrt wurden die Koordinaten angezeigt
\end{enumerate}
...
\subsection{Fazit}
Es konnten sämtliche für den Wettbewerb erforderlichen Tasks erfüllt werden. Jedoch ist die Fahrgeschwindigkeit im Moment noch zu tief um mit den schnelleren Teams mithalten zu können. Die Genauigkeit der anzeige konnte auch nicht genau kontrolliert werden. Die Werte erschienen aber vernünftig und plausibel.
