...
% TODO Konzeptänderungen erweitern
...
\begin{itemize}
		...
		\item Der Haken wird zusätzlich noch von einem Schwenkbegrenzer eingeschränkt. Damit wird sichergestellt, dass der Haken leicht nach hinten gerichtet ist um die Last besser aufheben oder absetzen zu können.
