...
\begin{itemize}
	...
	\item Die vorgegebene Höhe von 5 Zentimeter vom untersten Punkt des Hakens bis zum Boden muss eingestellt werden. Wenn sich der Haken an der korrekten Höhe befindet, muss der Stecker der Akkupacks am ET-Board eingesteckt werden damit der Schrittmotor die Hubvorrichtung hält.
	\item Der Kippschalter am ET-Board und der Reset-Knopf auf dem \textit{ArduinoDue} muss nun betätigt werden um das Gerät zu starten.
\end{itemize}
