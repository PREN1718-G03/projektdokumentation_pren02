...
Aus der Zeit zwischen Puls und Empfang kann danach über die folgende Formel ausgerechnet werden:
...
\begin{itemize}
	...
	\item Boardwahl\\
	Im Nachhinein gesehen, wäre es besser gewesen ein gemeinsames Board für die Entwicklung zu verwenden. Dadurch wäre eine Schnittstelle (Kommunikation) weggefallen, und es wären mehr Ressourcen (/Entwickler) zur Verfügung gestanden, die man frei verteilen hätte können. So wie es gelöst wurde (zwei verschiedene Boards) entstand beim Helfen ein Verlust beim Beschaffen und Einarbeiten, welchen man hätte vermeiden können.
