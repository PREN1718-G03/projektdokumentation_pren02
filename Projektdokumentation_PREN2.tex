...
\begin{enumerate}
	\item Laufkatze konnte in 1 Minute auf das Seil gesetzt werden.
	\item Mit dem Betätigen des I/O-Schalters wurde die Laufkatze gestartet
	\item Laufkatze greift Last
	\item Last wurde vor dem 1. Hindernis gehoben
	\item Last wird über Hindernisse transportiert
	\item Sensordaten wurden empfangen und der entsprechende weg gefahren
	\item Haken wurde auf Zielplattform abgesenkt
	\item Haken wurde Angehoben
	\item Gerät hat Zielmast berührt und Motoren wurden gestoppt
	\item Während der gesamten Fahrt wurden die Koordinaten angezeigt	\item Platform wurde nicht berührt
\end{enumerate}

\begin{itemize}	
	\item Inbetriebnahmezeit ~1 Minute
