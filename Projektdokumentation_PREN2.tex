...
Die Zusammenarbeit unter den Disziplinen hat aufgrund der Anwesenheit an beiden Schultagen gut funktioniert. Lösungen wurden, soweit als möglich, gemeinsam gesucht und auch gefunden. Einige Probleme hätten aber verhindert werden können, wenn die gesetzten Meilensteine und die Konsequenzen, falls nicht erreicht, eingehalten worden wären. Ein strikteres Vorgehen wäre rückblickend wünschenswert gewesen.
\listoffigures
