...
Wie in Abb. \ref{fig:RaspberryPins} dargestellt sind dies Pin 18 (Tx) und Pin 19 (Rx). Zusätzlich müssen beide Boards über Ground (GND) auf die Masse geführt werden.
\begin{figure}[h!]
	\centering
